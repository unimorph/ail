...
Source:
- `ail`: Aiton, Grant William. 2016. A grammar of Eibela: a language of the Western Province, Papua New Guinea

## Annotators
Grant Aiton, Edoardo Maria Ponti, Ekaterina Vylomova
...
## References
```
@phdthesis{aiton2016grammar,
  title={A grammar of Eibela: a language of the Western Province, Papua New Guinea},
  author={Aiton, Grant William},
  year={2016},
